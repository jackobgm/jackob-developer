	...
	<div class="section section-border-bottom">
		<div class="container">
			<div>
				...
				<form id="form-payment" action="{{ route('payWithPayPal') }}" method="get">
					...
					<td align="center" style="font-weight:700;" class="totalPrice">$75</td>
					</tr>
					<tr id="pendingpay">
					<td>
					Paypal Fee
					...
					<strong style="font-size:20px;" class="finalTotal">$75</strong>
					</td>
					</tr>
					</tbody></table>
